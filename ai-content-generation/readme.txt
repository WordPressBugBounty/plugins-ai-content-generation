...
* Fixed: Bulk Generation Error.
* Improved: Elementor AI Template Panel.
...
= 1.2.9 =
* New: Deepseek R1 Added.
* New: Deepseek Chat Added.
* Fixed: Minor issues.

= 1.2.8 =
* New: Claude 3.5 Sonnet Added.
* New: Claude 3.5 Haiku Added.
* Improved: Performance.
* Fixed: Minor issues.

= 1.2.7 =
* New: ChatGPT-4o-latest Added.
* New: GPT-4o-mini Added.
* New: GPT-4-turbo Added.
* Removed: OpenAI deprecated models.
* Fixed: Minor issues.
* Improved: Performance.
...
* Fixed: Minor bugs.
* Fixed: WordPress Compability Issues
* Improved: Performance.
...
= 1.2.2 =
* New: Premade AI Character Listed [Pro version only]
* Fixed: Minor Issue.

= 1.2.1 =
* New: AI Character Generator [Pro version only]
* Fixed: Bulk Generation Issue.

= 1.2.0 =
* New: Custom Prompt Template Generator [Pro version only]
* New: Business Information Control Inside Templates [Pro version only]
* Fixed: GPT-4 Content Generation Issue.

= 1.1.9 =
* New: Bulk Post Generation by Custom Headings [Pro version only]
* Fixed: Minor Issues.

= 1.1.8 =
* Fixed: Max Token Limit Issue is Solved.
* Fixed: Minor Issues.

= 1.1.7 =
* Fixed: Minor issues.
* Added: WordPress 6.3 support.
* New: Bulk Post Generation [Pro version only]

= 1.1.6 =
* New: 4 New Prompt added on gutenbarg asistant.
* New: Analytics prompt.
* Fixed: WooCommerce Translation Issue.

= 1.1.5 =
* New: AI Assistant on Classic Editor.
* New: GPT-4 Support.
* New: Templates Section Expnder.
* Fixed: Max Token Issue.

= 1.1.4 =
* New: One Click WooCommerce Product Description Writer.
* New: Beta Integration with Rank Math and Yoast SEO Plugin.
* New: Generated Result History.
* Improved: Word Limit of Long Form AI Blog Post is Improved.
* Fixed: GPT-3.5-Turbo-16k Model Issue is Fixed in Gutenberg.

= 1.1.3 =
* New: White Label for Agency.
* New: GPT-3.5-Turbo 16K is Added in Model List.
* New: AI Button Position Can Be Changed in Free Version.
* Improved: ChatGPT Assistant Can Do Many More Things Including Creating Tables, List etc.
* Update: 15+ New Writing Tones Added.

= 1.1.2 =
* New: AI Image Generation Using DALL-E.
* New: ChatGPT Hide and Show Settings.

= 1.1.1 =
* New: ChatGPT Like Content Generation Inside Gutenberg.
* Improved: 20+ Existing Templates.
* Fixed: Advanced Setting Fields.

= 1.1.0 =
* Improved: Translation quality.
* New: WPWand Toggle Position Settings.
* Fixed: Advanced Setting Fields.
...
= 1.0.6 =
* Fixed: Elementor Toggling Issue.
